...
class Data_Getter:
    ...
    def get_data(self) -> DataFrame:
        ...
        """
        self.logger_object.log(self.file_object, "Entered the get_data method of \
                                                 the Data_Getter class")
        try:
            # reading the data file
            data = pd.read_csv(self.training_file)
            self.logger_object.log(self.file_object, "Data Load Successful.Exited the get_data \
            ...
            self.logger_object.log(self.file_object,
                                   'Data Load Unsuccessful.Exited the get_data \
                                   method of the Data_Getter class')
            raise RuntimeError
