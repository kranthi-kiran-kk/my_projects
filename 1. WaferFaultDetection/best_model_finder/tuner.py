...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self, train_x, train_y):
        ...
        self.logger_object.log(
            self.file_object,
            "Entered the get_best_params_for_random_forest \
    ...
    def get_best_model(self, train_x, train_y, test_x, test_y):
        ...
        try:
            ...
            if len(test_y.unique()) == 1:
                ...
                # Log AUC
                self.logger_object.log(
                    self.file_object, f"Accuracy for XGBoost: {str(xgboost_score)}"
                )
            else:
                # AUC for XGBoost
            ...
            if len(test_y.unique()) == 1:
                ...
                self.logger_object.log(
                    self.file_object, f"Accuracy for RF:{str(random_forest_score)}"
                )
            else:
                random_forest_score = roc_auc_score(
                    test_y, prediction_random_forest
