...
function generateResponse(inputgiven) {
...
// 'use strict';
// // import DID_API from 'static/api.json' assert { type: 'json' };
// let DID_API;
...
// if (DID_API.key == 'key') alert('Please put your API key inside ./api.json and restart.');
